      ...
      <div className={classes.mostPopularLiveStreamCardImage}>
        ...
        <div className={classes.overlay}>
          ...
          <div className={classes.overlayBottom}>
            <Link to="/stream"><p className={classes.view}><FontAwesomeIcon icon={faEye} /> {props.views}</p></Link>
            <Link to="/stream"><p className={classes.gameName}><FontAwesomeIcon icon={faGamepad} /> {props.gameName}</p></Link>
          </div>
        </div>
      </div>
